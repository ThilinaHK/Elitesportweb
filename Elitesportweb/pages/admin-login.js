...
export default function AdminLogin() {
  ...
  return (
    <>
      ...
      {/* Login Section */}
      <section className="position-relative overflow-hidden" style={{minHeight: '100vh', background: 'linear-gradient(135deg, rgba(0,0,0,0.6), rgba(243,97,0,0.8)), url(/img/admin-bg.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', display: 'flex', alignItems: 'center', paddingTop: '100px'}}>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-5 col-md-7">
              <div className="text-center mb-5">
                ...
                <h1 className="text-white fw-bold mb-3" style={{fontSize: '2.5rem', textShadow: '2px 2px 4px rgba(0,0,0,0.5)'}}>Admin Login</h1>
                <p className="text-white-50" style={{fontSize: '1.1rem'}}>Access the administrative dashboard</p>
              </div>
              ...
              <div className="p-5 rounded-4" style={{background: 'rgba(255,255,255,0.95)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.2)', boxShadow: '0 20px 40px rgba(0,0,0,0.1)'}}>
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="position-relative">
                      <i className="fas fa-lock position-absolute" style={{left: '15px', top: '50%', transform: 'translateY(-50%)', color: '#f36100'}}></i>
                      <input
                        type="password"
                        className="form-control ps-5"
