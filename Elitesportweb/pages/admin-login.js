        ...
        <div style={{maxWidth: '1200px', margin: '0 auto', padding: '0 1rem'}}>
          <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '15px 0'}}>
            ...
            <nav style={{display: 'flex', alignItems: 'center', gap: '30px'}}>
              ...
              <a href="/admin-login" style={{color: '#f36100', textDecoration: 'none', fontWeight: '600', fontSize: '16px'}}>Admin</a>
            </nav>
          </div>
        </div>
      </header>
      ...
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f5f5f5', paddingTop: '90px' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            style={{ width: '100%', padding: '0.75rem', background: '#f36100', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }}
          >
